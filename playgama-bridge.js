(() => {
  ...
  r.n = e => {
    ...
    var be = "created",
      ...
      Re = function() {
        ...
        return t = e, (r = [{
          ...
          value: function() {
            var e = this;
            Se(this, we) !== be && Se(this, we) !== Ee || (_e(this, Ae, Se(this, Pe)), ve(this, ke, Te).call(this, "started"), _e(this, Oe, setInterval((function() {
              _e(e, Ae, Se(e, Ae) - 1), e.emit("time_left_changed", Se(e, Ae)), Se(e, Ae) <= 0 && (ve(e, De, Ie).call(e), ve(e, ke, Te).call(e, Ee))
            }), 1e3)))
          }
        }, {
          key: "stop",
    ...
    function Te(e) {
      _e(this, we, e), this.emit("state_changed", Se(this, we))
    }

    function Ie() {
      _e(this, Ae, 0), clearInterval(Se(this, Oe))
    }
    $().mixin(Re.prototype);
    const Le = Re;
    ...
    function St(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, gt(o.key), o)
      }
    }
    ...
    const dr = function(t) {
      ...
      return r = d, (o = [{
        ...
        value: function(e) {
          var t = {};
          return e && e.message && (t.message = e.message), e && e.attachments && (t.attachments = e.attachments), sr(this, fr, pr).call(this, f.CREATE_POST, "VKWebAppShowWallPostBox", t, "post_id")
        }
      }, {
        key: "addToHomeScreen",
        value: function() {
    ...
    function Sr() {
      return Sr = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, r) {
        var o = function(e, t) {
    ...
    const Cr = function(t) {
      ...
      return r = y, (o = [{
        ...
        key: "platformLanguage",
        get: function() {
          return this._platformSdk ? this._platformSdk.environment.i18n.lang.toLowerCase() : Sr(Er(y.prototype), "platformLanguage", this)
        }
      }, {
        key: "platformTld",
        get: function() {
          return this._platformSdk ? this._platformSdk.environment.i18n.tld.toLowerCase() : Sr(Er(y.prototype), "platformTld", this)
        }
      }, {
        key: "deviceType",
        get: function() {
          switch (this._platformSdk && this._platformSdk.deviceInfo.type) {
            ...
            case c.TV:
              return c.TV;
            default:
              return Sr(Er(y.prototype), "deviceType", this)
          }
        }
      }, {
        key: "isPlayerAuthorizationSupported",
        ...
        value: function(e) {
          switch (e) {
            ...
            default:
              return Sr(Er(y.prototype), "sendMessage", this).call(this, e)
          }
        }
      }, {
        key: "getServerTime",
        ...
        key: "isStorageSupported",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL || Sr(Er(y.prototype), "isStorageSupported", this).call(this, e)
        }
      }, {
        key: "isStorageAvailable",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL ? this._isPlayerAuthorized : Sr(Er(y.prototype), "isStorageAvailable", this).call(this, e)
        }
      }, {
        key: "getDataFromStorage",
        value: function(e, t, r) {
          ...
          })) : Promise.reject() : Sr(Er(y.prototype), "getDataFromStorage", this).call(this, e, t, r)
        }
      }, {
        key: "setDataToStorage",
        value: function(e, t, r) {
          ...
          })) : Sr(Er(y.prototype), "setDataToStorage", this).call(this, e, t, r)
        }
      }, {
        key: "deleteDataFromStorage",
        value: function(e, t) {
          ...
          })) : Sr(Er(y.prototype), "deleteDataFromStorage", this).call(this, e, t)
        }
      }, {
        key: "showBanner",
        value: function() {
    ...
    function eo() {
      var e = this;
      return Kr(this, $r) ? new Promise((function(t, r) {
    ...
    const to = function(t) {
      ...
      function y() {
        ...
        return Vr(t = zr(e = d.call.apply(d, [this].concat(n))), r = Qr), r.add(t), xr(zr(e), qr, {
          writable: !0,
          value: !1
        }), xr(zr(e), $r, {
          writable: !0,
          ...
          value: {
            adStarted: function() {
              Kr(zr(e), qr) ? e._setRewardedState(a.OPENED) : e._setInterstitialState(i.OPENED)
            },
            adFinished: function() {
              Kr(zr(e), qr) ? (e._setRewardedState(a.REWARDED), e._setRewardedState(a.CLOSED)) : e._setInterstitialState(i.CLOSED)
            },
            adError: function() {
              Kr(zr(e), qr) ? e._setRewardedState(a.FAILED) : e._setInterstitialState(i.FAILED)
            }
          }
        }), e
      }
      return r = y, (o = [{
        ...
        key: "platformLanguage",
        get: function() {
          return Kr(this, $r) ? this._platformSdk.user.systemInfo.countryCode.toLowerCase() : Hr(Wr(y.prototype), "platformLanguage", this)
        }
      }, {
        key: "isPlayerAuthorizationSupported",
        get: function() {
          ...
          return t || (t = this._createPromiseDecorator(f.INITIALIZE), $t("https://sdk.crazygames.com/crazygames-sdk-v3.js").then((function() {
            Xt("CrazyGames", "SDK", "init").then((function() {
              e._platformSdk = window.CrazyGames.SDK, e._defaultStorageType = u.LOCAL_STORAGE, e._isBannerSupported = !0, e._platformSdk.init().then((function() {
                Zr(e, $r, e._platformSdk.user.isUserAccountAvailable);
                var t = Yr(e, Qr, eo).call(e);
        ...
        value: function() {
          var e = this;
          if (!Kr(this, $r)) return Promise.reject();
          ...
          return t || (t = this._createPromiseDecorator(f.AUTHORIZE_PLAYER), this._platformSdk.user.showAuthPrompt().then((function() {
            Yr(e, Qr, eo).call(e).then((function() {
        ...
        value: function(e) {
          var t = this;
          e && e.containerId && "string" == typeof e.containerId ? this._platformSdk.banner.requestResponsiveBanner([e.containerId]).then((function() {
        ...
        key: "hideBanner",
        value: function() {
          this._platformSdk.banner.clearAllBanners(), this._setBannerState(s.HIDDEN)
        }
      }, {
        key: "showInterstitial",
        value: function() {
          Zr(this, qr, !1), this._platformSdk.ad.requestAd("midgame", Kr(this, Xr))
        }
      }, {
        key: "showRewarded",
        value: function() {
          Zr(this, qr, !0), this._platformSdk.ad.requestAd("rewarded", Kr(this, Xr))
        }
      }, {
        key: "checkAdBlock",
        value: function() {
    ...
    function no(e) {
      for (var t = 1; t < arguments.length; t++) {
        ...
        t % 2 ? oo(Object(r), !0).forEach((function(t) {
          var o, n, i;
          o = e, n = t, i = r[t], (n = ao(n)) in o ? Object.defineProperty(o, n, {
            value: i,
            enumerable: !0,
            configurable: !0,
            writable: !0
    ...
    function io(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, ao(o.key), o)
      }
    }
    ...
    function so() {
      return so = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, r) {
        var o = function(e, t) {
          for (; !Object.prototype.hasOwnProperty.call(e, t) && null !== (e = lo(e)););
          return e
        }(e, t);
        if (o) {
          var n = Object.getOwnPropertyDescriptor(o, t);
    ...
    function lo(e) {
      return lo = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e) {
        return e.__proto__ || Object.getPrototypeOf(e)
      }, lo(e)
    }
    var fo = new WeakSet;
    ...
    const yo = function(t) {
      ...
      var r, o, n, s, c = (n = l, s = function() {
        ...
        return function(e, t) {
          if (t && ("object" === ro(t) || "function" == typeof t)) return t;
          if (void 0 !== t) throw new TypeError("Derived constructors may only return object or undefined");
          return co(e)
        }(this, e)
      });
      ...
      function l() {
        ...
        return function(e, t) {
          if (t.has(e)) throw new TypeError("Cannot initialize the same private elements twice on an object")
        }(t = co(e = c.call.apply(c, [this].concat(n))), r = fo), r.add(t), e
      }
      return r = l, (o = [{
        key: "platformId",
        get: function() {
        ...
        key: "isStorageSupported",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL || so(lo(l.prototype), "isStorageSupported", this).call(this, e)
        }
      }, {
        key: "isStorageAvailable",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL ? this._isPlayerAuthorized : so(lo(l.prototype), "isStorageAvailable", this).call(this, e)
        }
      }, {
        key: "getDataFromStorage",
        value: function(e, t, r) {
          ...
          })) : so(lo(l.prototype), "getDataFromStorage", this).call(this, e, t, r)
        }
      }, {
        key: "setDataToStorage",
        value: function(e, t, r) {
          ...
          return r === u.PLATFORM_INTERNAL ? new Promise((function(r, n) {
            if (o._isPlayerAuthorized) {
              var i = null !== o._platformStorageCachedData ? no({}, o._platformStorageCachedData) : {};
              if (Array.isArray(e))
                for (var a = 0; a < e.length; a++) i[e[a]] = t[a];
              else i[e] = t;
          ...
          })) : so(lo(l.prototype), "setDataToStorage", this).call(this, e, t, r)
        }
      }, {
        key: "deleteDataFromStorage",
        value: function(e, t) {
          ...
          return t === u.PLATFORM_INTERNAL ? new Promise((function(t, o) {
            if (r._isPlayerAuthorized) {
              var n = null !== r._platformStorageCachedData ? no({}, r._platformStorageCachedData) : {};
              if (Array.isArray(e))
                for (var i = 0; i < e.length; i++) delete n[e[i]];
              else delete n[e];
          ...
          })) : so(lo(l.prototype), "deleteDataFromStorage", this).call(this, e, t)
        }
      }, {
        key: "showInterstitial",
        value: function() {
    ...
    function mo(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, vo(o.key), o)
      }
    }
    ...
    function vo(e) {
      var t = function(e, t) {
        ...
        if (void 0 !== r) {
          var o = r.call(e, "string");
          if ("object" != ho(o)) return o;
          throw new TypeError("@@toPrimitive must return a primitive value.")
        }
        return String(e)
      }(e);
      return "symbol" == ho(t) ? t : String(t)
    }

    function _o(e, t) {
      return _o = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
        return e.__proto__ = t, e
      }, _o(e, t)
    }
    ...
    const wo = function(t) {
      ...
      return r = p, (o = [{
            ...
            if (e = this._createPromiseDecorator(f.INITIALIZE), this._options && "string" == typeof this._options.gameId) {
              ...
              window.GD_OPTIONS = {
                ...
                onEvent: function(e) {
                  switch (e.name) {
                    case "SDK_READY":
                      t._platformSdk = window.gdsdk, t._platformSdk.preloadAd("rewarded"), t._isInitialized = !0, t._resolvePromiseDecorator(f.INITIALIZE);
                      break;
                    case "SDK_GAME_START":
                      Eo(t, Ao) ? t._setRewardedState(a.CLOSED) : t._setInterstitialState(i.CLOSED);
                      break;
                    case "SDK_GAME_PAUSE":
                      Eo(t, Ao) ? t._setRewardedState(a.OPENED) : t._setInterstitialState(i.OPENED);
                      break;
        ...
        value: function() {
          var e = this;
          bo(this, Ao, !1), this._platformSdk ? this._platformSdk.showAd().catch((function() {
            e._setInterstitialState(i.FAILED)
          })) : this._setInterstitialState(i.FAILED)
        }
      }, {
        ...
        value: function() {
          var e = this;
          bo(this, Ao, !0), this._platformSdk ? this._platformSdk.showAd("rewarded").catch((function() {
            e._setRewardedState(a.FAILED)
          })) : this._setRewardedState(a.FAILED)
        }
      }]) && mo(r.prototype, o), Object.defineProperty(r, "prototype", {
        writable: !1
      }), p
    }(qt);
    ...
    function Ro(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, Fo(o.key), o)
      }
    }

    function To() {
      return To = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, r) {
        var o = function(e, t) {
          for (; !Object.prototype.hasOwnProperty.call(e, t) && null !== (e = jo(e)););
          return e
        }(e, t);
        if (o) {
          var n = Object.getOwnPropertyDescriptor(o, t);
    ...
    function Io(e, t) {
      return Io = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
        return e.__proto__ = t, e
      }, Io(e, t)
    }
    ...
    function ln() {
      ...
      return {
        userProfileCallback: function(t, r, o) {
          return Go(e, Yo, pn).call(e, t, r, o)
        },
        hasValueAccessCallback: function(t, r, o) {
          return Go(e, Ko, yn).call(e, r, o)
        }
      }
    }
    ...
    function fn() {
      ...
      return {
        showPermissions: function() {
          return Go(e, Jo, hn).call(e)
        },
        loadAd: function(t) {
          return Go(e, qo, mn).call(e, t)
        },
        showLoadedAd: function(t, r) {
          return Go(e, $o, vn).call(e, r)
        },
        showAd: function(t, r) {
          return Go(e, Xo, _n).call(e, r)
        },
        requestBannerAds: function(t, r) {
          return Go(e, Qo, Sn).call(e, t, r)
        },
        showBannerAds: function(t, r) {
          return Go(e, tn, bn).call(e, r)
        },
        hideBannerAds: function(t, r) {
          return Go(e, en, gn).call(e, r)
        },
        setBannerFormat: function(t) {
          return Go(e, rn, En).call(e, t)
        },
        showInvite: function(t) {
          return Go(e, on, Pn).call(e, t)
        },
        showRatingDialog: function(t, r) {
          return Go(e, nn, An).call(e, t, r)
        },
        joinGroup: function(t, r) {
          return Go(e, an, wn).call(e, t, r)
        },
        showLoginSuggestion: function(t, r) {
          return Go(e, Zo, dn).call(e, t, r)
        },
        postMediatopic: function(t, r) {
          return Go(e, sn, On).call(e, t, r)
        },
        isAdBlockEnabled: function(t, r) {
          return Go(e, un, kn).call(e, t, r)
        }
      }
    }

    function pn(e, t) {
      "ok" === e && (this._playerId = t.uid, this._playerName = t.name, this._playerPhotos = [t.pic50x50, t.pic128x128, t.pic_base]), this._isInitialized = !0, this._platformSdk.Client.call(Ho(this, Wo).hasAppPermission(zo.VALUABLE_ACCESS), Ho(this, xo).hasValueAccessCallback)
    }
    ...
    function yn(e) {
      if (this._hasValuableAccessPermission = !!e, this._defaultStorageType = this._hasValuableAccessPermission ? u.PLATFORM_INTERNAL : u.LOCAL_STORAGE, this._hasValuableAccessPermission || this._hasValuableAccessPermissionShowed) this._resolvePromiseDecorator(f.INITIALIZE);
        ...
        var t = Object.values(zo).map((function(e) {
          return '"'.concat(e, '"')
        })).join(",");
    ...
    function hn() {
      this._hasValuableAccessPermissionShowed = !0, this._platformSdk.Client.call(Ho(this, Wo).hasAppPermission(zo.VALUABLE_ACCESS), Ho(this, xo).hasValueAccessCallback)
    }
    ...
    const Dn = function(t) {
      ...
      function l() {
        ...
        return No(Lo(e = c.call.apply(c, [this].concat(r))), un), No(Lo(e), sn), No(Lo(e), an), No(Lo(e), nn), No(Lo(e), on), No(Lo(e), rn), No(Lo(e), tn), No(Lo(e), en), No(Lo(e), Qo), No(Lo(e), Xo), No(Lo(e), $o), No(Lo(e), qo), No(Lo(e), Jo), No(Lo(e), Ko), No(Lo(e), Zo), No(Lo(e), Yo), Co(Lo(e), Vo, {
          get: fn,
          set: void 0
        }), Co(Lo(e), xo, {
          get: ln,
          ...
          get: cn,
          set: void 0
        }), Mo(Lo(e), "_hasValuableAccessPermission", !1), Mo(Lo(e), "_hasValuableAccessPermissionShowed", !1), Mo(Lo(e), "_platformBannerOptions", {}), e
      }
      return r = l, (o = [{
        key: "platformId",
        get: function() {
          ...
          return t || (t = this._createPromiseDecorator(f.INITIALIZE), $t("//api.ok.ru/js/fapi5.js").then((function() {
            Xt("FAPI").then((function() {
              ...
              t.api_server && t.apiconnection ? e._platformSdk.init(t.api_server, t.apiconnection, (function() {
                ...
                e._isPlayerAuthorized = !r || r === Uo, e._isPlayerAuthorized ? e._platformSdk.Client.call(Ho(e, Wo).userProfile, Ho(e, xo).userProfileCallback) : (e._isInitialized = !0, e._resolvePromiseDecorator(f.INITIALIZE))
              }), (function() {
        ...
        value: function() {
          ...
          return e || (e = this._createPromiseDecorator(f.AUTHORIZE_PLAYER), this._platformSdk.UI.showLoginSuggestion(Uo)), e.promise
        }
      }, {
        key: "isStorageSupported",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL || To(jo(l.prototype), "isStorageSupported", this).call(this, e)
        }
      }, {
        key: "isStorageAvailable",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL ? this._hasValuableAccessPermission : To(jo(l.prototype), "isStorageAvailable", this).call(this, e)
        }
      }, {
        key: "getDataFromStorage",
        value: function(e, t, r) {
          ...
          })) : Promise.reject(y) : To(jo(l.prototype), "getDataFromStorage", this).call(this, e, t, r)
        }
      }, {
        key: "setDataToStorage",
        value: function(e, t, r) {
          ...
          return To(jo(l.prototype), "setDataToStorage", this).call(this, e, t, r)
        }
      }, {
        key: "deleteDataFromStorage",
        value: function(e, t) {
          ...
          return To(jo(l.prototype), "deleteDataFromStorage", this).call(this, e, t)
        }
      }, {
        key: "showInterstitial",
        value: function() {
        ...
        value: function(e) {
          if (e) {
            if ("string" == typeof e.layoutType) return this._platformBannerOptions = Do(Do({}, e), {}, {
              layoutType: null
        ...
        value: function(e) {
          ...
          return r || (r = this._createPromiseDecorator(f.INVITE_FRIENDS), t.length > 120 ? this._rejectPromiseDecorator(f.INVITE_FRIENDS, S) : this._platformSdk.UI.showInvite(t)), r.promise
        }
      }, {
        key: "rate",
        value: function() {
      ...
      }]) && Ro(r.prototype, o), Object.defineProperty(r, "prototype", {
        writable: !1
      }), l
    }(qt);
    ...
    function Tn(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, In(o.key), o)
      }
    }
    ...
    const Nn = function(t) {
        ...
        value: function() {
          ...
          return t || (t = this._createPromiseDecorator(f.INITIALIZE), $t("https://developer.playgama.com/sdk/v1.js").then((function() {
            Xt("PLAYGAMA_SDK").then((function() {
              e._platformSdk = window.PLAYGAMA_SDK, e._isInitialized = !0, e._resolvePromiseDecorator(f.INITIALIZE)
            }))
          }))), t.promise
        }
      }, {
      ...
      }]) && Tn(r.prototype, o), Object.defineProperty(r, "prototype", {
        writable: !1
      }), c
    }(qt);
    ...
    function Bn(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, zn(o.key), o)
      }
    }

    function Mn() {
      return Mn = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, r) {
        var o = function(e, t) {
    ...
    function Hn(e) {
      return Hn = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e) {
        return e.__proto__ || Object.getPrototypeOf(e)
      }, Hn(e)
    }
    ...
    const Jn = function(t) {
      ...
      function p() {
        ...
        for (var t = arguments.length, r = new Array(t), o = 0; o < t; o++) r[o] = arguments[o];
        return Wn(Gn(e = c.call.apply(c, [this].concat(r))), Zn, {
          writable: !0,
          value: void 0
        }), Wn(Gn(e), Kn, {
          writable: !0,
          value: void 0
        }), Un(Gn(e), "_defaultStorageType", u.PLATFORM_INTERNAL), Un(Gn(e), "_isPlayerAuthorized", !0), e
      }
      return r = p, (o = [{
        key: "platformId",
        get: function() {
        ...
        key: "platformLanguage",
        get: function() {
          return Vn(this, Zn) ? Vn(this, Zn) : Mn(Hn(p.prototype), "platformLanguage", this)
        }
      }, {
        key: "isPlayerAuthorizationSupported",
        get: function() {
          ...
          return t || (t = this._createPromiseDecorator(f.INITIALIZE), window.addEventListener("message", (function t(r) {
            ...
            if (o && o.playdeck) {
              ...
              if ("getUserProfile" === n.method) {
                var i = n.value;
                e._playerId = i.telegramId, e._playerPhotos = [i.avatar], e._playerName = i.username, xn(e, Zn, i.locale), xn(e, Kn, i.params), window.removeEventListener("message", t), e._isInitialized = !0, e._resolvePromiseDecorator(f.INITIALIZE)
              }
            }
        ...
        value: function(e) {
          switch (e) {
            ...
            default:
              return Mn(Hn(p.prototype), "sendMessage", this).call(this, e)
          }
        }
      }, {
        key: "showInterstitial",
        ...
        key: "isStorageSupported",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL || Mn(Hn(p.prototype), "isStorageSupported", this).call(this, e)
        }
      }, {
        key: "isStorageAvailable",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL || Mn(Hn(p.prototype), "isStorageAvailable", this).call(this, e)
        }
      }, {
        key: "getDataFromStorage",
        value: function(e, t, r) {
          ...
          })) : Mn(Hn(p.prototype), "getDataFromStorage", this).call(this, e, t, r)
        }
      }, {
        key: "setDataToStorage",
        value: function(e, t, r) {
          ...
          })) : Mn(Hn(p.prototype), "setDataToStorage", this).call(this, e, t, r)
        }
      }, {
        key: "deleteDataFromStorage",
        value: function(e, t) {
          ...
          })) : Mn(Hn(p.prototype), "deleteDataFromStorage", this).call(this, e, t)
        }
      }, {
        key: "share",
        value: function() {
      ...
      }]) && Bn(r.prototype, o), Object.defineProperty(r, "prototype", {
        writable: !1
      }), p
    }(qt);
    ...
    function Xn(e) {
      for (var t = 1; t < arguments.length; t++) {
        ...
        t % 2 ? $n(Object(r), !0).forEach((function(t) {
          var o, n, i;
          o = e, n = t, i = r[t], (n = ei(n)) in o ? Object.defineProperty(o, n, {
            value: i,
            enumerable: !0,
            configurable: !0,
            writable: !0
    ...
    function Qn(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, ei(o.key), o)
      }
    }
    ...
    function ti() {
      return ti = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, r) {
        var o = function(e, t) {
    ...
    const fi = function(t) {
      ...
      function d() {
        ...
        for (var o = arguments.length, n = new Array(o), i = 0; i < o; i++) n[i] = arguments[i];
        return ii(t = oi(e = p.call.apply(p, [this].concat(n))), r = ci), r.add(t),
          function(e, t, r) {
            ii(e, t), t.set(e, {
              writable: !0,
              value: void 0
      ...
      return r = d, (o = [{
        ...
        get: function() {
          ...
          return ti(ni(d.prototype), "platformLanguage", this)
        }
      }, {
        key: "deviceType",
        get: function() {
          var e = this._platformSdk.session.getDevice();
          return e ? e.toLowerCase() : ti(ni(d.prototype), "deviceType", this)
        }
      }, {
        key: "isExternalLinksAllowed",
        get: function() {
          ...
          return t || (t = this._createPromiseDecorator(f.INITIALIZE), $t("https://storage.googleapis.com/cdn-wortal-ai/v2/wortal-core.js").then((function() {
            Xt("Wortal", "initializeAsync").then((function() {
              window.Wortal.initializeAsync().then((function() {
                var t, r, o;
                e._platformSdk = window.Wortal, t = e, r = ui, o = e._platformSdk.getSupportedAPIs(),
                  function(e, t, r) {
                    if (t.set) t.set.call(e, r);
                    else {
                      if (!t.writable) throw new TypeError("attempted to set read only private field");
                  ...
                  }(t, si(t, r, "set"), o), e._isBannerSupported = ai(e, ui).includes("ads.showBanner"), e._platformSdk.player.onLogin(function(e, t, r) {
                    if (!t.has(e)) throw new TypeError("attempted to get private field on non-instance");
                    return r
                  }(e, ci, li)), e._isInitialized = !0, e._resolvePromiseDecorator(f.INITIALIZE)
              }))
            }))
          }))), t.promise
        }
        ...
        value: function(e) {
          switch (e) {
            ...
            default:
              return ti(ni(d.prototype), "sendMessage", this).call(this, e)
          }
        }
      }, {
        key: "showBanner",
        ...
        key: "isStorageSupported",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL ? ai(this, ui).includes("player.setDataAsync") : ti(ni(d.prototype), "isStorageSupported", this).call(this, e)
        }
      }, {
        key: "isStorageAvailable",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL ? ai(this, ui).includes("player.setDataAsync") : ti(ni(d.prototype), "isStorageAvailable", this).call(this, e)
        }
      }, {
        key: "getDataFromStorage",
        value: function(e, t, r) {
          ...
          })) : ti(ni(d.prototype), "getDataFromStorage", this).call(this, e, t, r)
        }
      }, {
        key: "setDataToStorage",
        value: function(e, t, r) {
          var o = this;
          return r === u.PLATFORM_INTERNAL ? new Promise((function(r, n) {
            var i = null !== o._platformStorageCachedData ? Xn({}, o._platformStorageCachedData) : {};
            if (Array.isArray(e))
              for (var a = 0; a < e.length; a++) i[e[a]] = t[a];
            else i[e] = t;
          ...
          })) : ti(ni(d.prototype), "setDataToStorage", this).call(this, e, t, r)
        }
      }, {
        key: "deleteDataFromStorage",
        value: function(e, t) {
          var r = this;
          return t === u.PLATFORM_INTERNAL ? new Promise((function(t, o) {
            var n = null !== r._platformStorageCachedData ? Xn({}, r._platformStorageCachedData) : {};
            if (Array.isArray(e))
              for (var i = 0; i < e.length; i++) delete n[e[i]];
            else delete n[e];
          ...
          })) : ti(ni(d.prototype), "deleteDataFromStorage", this).call(this, e, t)
        }
      }]) && Qn(r.prototype, o), Object.defineProperty(r, "prototype", {
        writable: !1
      }), d
    }(qt);
    ...
    function di(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, gi(o.key), o)
      }
    }

    function yi() {
      return yi = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, r) {
        var o = function(e, t) {
    ...
    function hi(e, t) {
      return hi = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
        return e.__proto__ = t, e
      }, hi(e, t)
    }
    ...
    function gi(e) {
      var t = function(e, t) {
        if ("object" != pi(e) || !e) return e;
        var r = e[Symbol.toPrimitive];
        if (void 0 !== r) {
          var o = r.call(e, "string");
          if ("object" != pi(o)) return o;
          throw new TypeError("@@toPrimitive must return a primitive value.")
        }
        return String(e)
      }(e);
    ...
    const Di = function(t) {
      ...
      function d() {
        ...
        for (var t = arguments.length, r = new Array(t), o = 0; o < t; o++) r[o] = arguments[o];
        return Si(mi(e = p.call.apply(p, [this].concat(r))), "_defaultStorageType", u.PLATFORM_INTERNAL), Si(mi(e), "_isPlayerAuthorized", !0), _i(mi(e), Ai, {
          writable: !0,
          value: void 0
        }), _i(mi(e), wi, {
          writable: !0,
      ...
      return r = d, (o = [{
        ...
        key: "platformLanguage",
        get: function() {
          return this._platformSdk ? this._platformSdk.initDataUnsafe.user.language_code : yi(vi(d.prototype), "platformLanguage", this)
        }
      }, {
        key: "deviceType",
        get: function() {
          switch (Ei(this, Ai)) {
            ...
            case "macos":
              return c.DESKTOP;
            default:
              return yi(vi(d.prototype), "deviceType", this)
          }
        }
      }, {
        key: "isPlayerAuthorizationSupported",
        ...
        value: function() {
          ...
          return t || (t = this._createPromiseDecorator(f.INITIALIZE), $t("https://telegram.org/js/telegram-web-app.js").then((function() {
            ...
            e._playerId = t.id, e._playerName = [t.first_name, t.last_name].filter(Boolean).join(" "), e._playerPhotos = [t.photo_url], bi(e, Ai, e._platformSdk.platform), e._isInitialized = !0, e._options && e._options.adsgramBlockId ? $t("https://sad.adsgram.ai/js/sad.min.js").then((function() {
              bi(e, wi, window.Adsgram.init({
        ...
        key: "sendMessage",
        value: function(e) {
          return e === l.GAME_READY ? (this._platformSdk.ready(), Promise.resolve()) : yi(vi(d.prototype), "sendMessage", this).call(this, e)
        }
      }, {
        key: "isStorageSupported",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL || yi(vi(d.prototype), "isStorageSupported", this).call(this, e)
        }
      }, {
        key: "isStorageAvailable",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL || yi(vi(d.prototype), "isStorageAvailable", this).call(this, e)
        }
      }, {
        key: "getDataFromStorage",
        value: function(e, t, r) {
          ...
          })) : yi(vi(d.prototype), "getDataFromStorage", this).call(this, e, t)
        }
      }, {
        key: "setDataToStorage",
        value: function(e, t, r) {
          ...
          })) : yi(vi(d.prototype), "setDataToStorage", this).call(this, e, t, r)
        }
      }, {
        key: "deleteDataFromStorage",
        value: function(e, t) {
          ...
          })) : yi(vi(d.prototype), "deleteDataFromStorage", this).call(this, e, t)
        }
      }, {
        key: "showInterstitial",
        value: function() {
          var e = this;
          Ei(this, wi) ? (Ei(this, wi).addEventListener("onStart", Ei(this, ki).onStart), Ei(this, wi).addEventListener("onSkip", Ei(this, ki).onSkip), Ei(this, wi).addEventListener("onError", Ei(this, ki).onError), Ei(this, wi).addEventListener("onBannerNotFound", Ei(this, ki).onError), Ei(this, wi).show().finally((function() {
            Ei(e, wi).removeEventListener("onStart", Ei(e, ki).onStart), Ei(e, wi).removeEventListener("onSkip", Ei(e, ki).onSkip), Ei(e, wi).removeEventListener("onError", Ei(e, ki).onError), Ei(e, wi).removeEventListener("onBannerNotFound", Ei(e, ki).onError)
          }))) : this._setInterstitialState(i.FAILED)
        }
      }, {
        key: "showRewarded",
        value: function() {
          var e = this;
          Ei(this, wi) ? (Ei(this, wi).addEventListener("onStart", Ei(this, Oi).onStart), Ei(this, wi).addEventListener("onSkip", Ei(this, Oi).onSkip), Ei(this, wi).addEventListener("onReward", Ei(this, Oi).onReward), Ei(this, wi).addEventListener("onError", Ei(this, Oi).onError), Ei(this, wi).addEventListener("onBannerNotFound", Ei(this, Oi).onError), Ei(this, wi).show().finally((function() {
            Ei(e, wi).addEventListener("onStart", Ei(e, Oi).onStart), Ei(e, wi).addEventListener("onSkip", Ei(e, Oi).onSkip), Ei(e, wi).addEventListener("onReward", Ei(e, Oi).onReward), Ei(e, wi).addEventListener("onError", Ei(e, Oi).onError), Ei(e, wi).addEventListener("onBannerNotFound", Ei(e, Oi).onError)
          }))) : this._setRewardedState(a.FAILED)
        }
      }, {
        key: "clipboardRead",
      ...
      }]) && di(r.prototype, o), Object.defineProperty(r, "prototype", {
        writable: !1
      }), d
    }(qt);
    var Ri = ["player"];
    ...
    function Ii(e) {
      for (var t = 1; t < arguments.length; t++) {
        ...
        t % 2 ? Ti(Object(r), !0).forEach((function(t) {
          var o, n, i;
          o = e, n = t, i = r[t], (n = Ni(n)) in o ? Object.defineProperty(o, n, {
            value: i,
            enumerable: !0,
            configurable: !0,
            writable: !0
    ...
    function ji(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, Ni(o.key), o)
      }
    }
    ...
    function Ci() {
      return Ci = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, r) {
        var o = function(e, t) {
    ...
    const Zi = function(t) {
      ...
      function l() {
        ...
        for (var t = arguments.length, r = new Array(t), o = 0; o < t; o++) r[o] = arguments[o];
        return Gi(Mi(e = c.call.apply(c, [this].concat(r))), xi), Gi(Mi(e), Wi), e
      }
      return r = l, (o = [{
        key: "platformId",
        get: function() {
          ...
          return r || (r = this._createPromiseDecorator(f.INITIALIZE), null !== (t = this._options) && void 0 !== t && t.gameId ? $t("https://cdn.y8.com/api/sdk.js").then((function() {
            Xt("ID").then((function() {
              e._platformSdk = window.ID, e._platformSdk.Event.subscribe("id.init", (function() {
                var t, r, o, n;
                (t = {
                  hostId: "ca-host-pub-".concat(zi),
                  adsenseId: e._options.channelId ? "ca-pub-".concat(zi) : e._options.adsenseId,
                  channelId: e._options.channelId
                }, r = t.hostId, o = t.adsenseId, n = t.channelId, new Promise((function(e) {
                  var t = document.createElement("script");
                  t.setAttribute("data-ad-client", o), n ? t.setAttribute("data-ad-channel", n) : r && t.setAttribute("data-ad-host", r), t.setAttribute("data-ad-frequency-hint", "30s"), t.src = "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js", t.addEventListener("load", e), document.head.appendChild(t)
                }))).then((function() {
                  ...
                  Hi(e, xi, Yi).call(e, t), e._isInitialized = !0, e._resolvePromiseDecorator(f.INITIALIZE)
                }))
              })), e._platformSdk.init({
        ...
        value: function() {
          ...
          return this._isPlayerAuthorized ? Promise.resolve() : new Promise((function(t, r) {
            e._platformSdk.login((function(o) {
              Hi(e, xi, Yi).call(e, o), "ok" === o.status ? t() : r()
            }))
          }))
        }
      }, {
        key: "isStorageSupported",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL || Ci(Fi(l.prototype), "isStorageSupported", this).call(this, e)
        }
      }, {
        key: "isStorageAvailable",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL ? this._isPlayerAuthorized : Ci(Fi(l.prototype), "isStorageAvailable", this).call(this, e)
        }
      }, {
        key: "getDataFromStorage",
        value: function(e, t, r) {
          var o = this;
          return t === u.PLATFORM_INTERNAL ? new Promise((function(t, n) {
            Hi(o, Wi, Vi).call(o).then((function(o) {
              var n = (Array.isArray(e) ? e : [e]).map((function(e) {
                var t = o[e];
                return r || "object" !== Li(t) || null === t ? null != t ? t : null : JSON.stringify(t)
              }));
              t(n)
            })).catch(n)
          })) : Ci(Fi(l.prototype), "getDataFromStorage", this).call(this, e, t, r)
        }
      }, {
        key: "setDataToStorage",
        value: function(e, t, r) {
          var o = this;
          return r === u.PLATFORM_INTERNAL ? new Promise((function(r, n) {
            Hi(o, Wi, Vi).call(o).then((function(i) {
              var a = Ii({}, i);
              if (Array.isArray(e))
          ...
          })) : Ci(Fi(l.prototype), "setDataToStorage", this).call(this, e, t, r)
        }
      }, {
        key: "deleteDataFromStorage",
        value: function(e, t) {
          var r = this;
          return t === u.PLATFORM_INTERNAL ? new Promise((function(t, o) {
            Hi(r, Wi, Vi).call(r).then((function(n) {
              var i = Ii({}, n);
              if (Array.isArray(e))
          ...
          })) : Ci(Fi(l.prototype), "deleteDataFromStorage", this).call(this, e, t)
        }
      }, {
        key: "showInterstitial",
        value: function() {
        ...
        value: function(e) {
          ...
          var r = this._getPromiseDecorator(f.GET_LEADERBOARD_SCORE);
          return r || (r = this._createPromiseDecorator(f.GET_LEADERBOARD_SCORE), this._platformSdk.GameAPI.Leaderboards.listCustom(Ii(Ii({}, e), {}, {
      ...
      }]) && ji(r.prototype, o), Object.defineProperty(r, "prototype", {
        writable: !1
      }), l
    }(qt);
    ...
    function Ji(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, qi(o.key), o)
      }
    }
    ...
    const ea = function(t) {
      ...
      return r = l, (o = [{
        ...
        key: "isStorageSupported",
        value: function(e) {
          return e !== u.PLATFORM_INTERNAL && $i(Qi(l.prototype), "isStorageSupported", this).call(this, e)
        }
      }, {
        key: "isStorageAvailable",
        value: function(e) {
          return e !== u.PLATFORM_INTERNAL && $i(Qi(l.prototype), "isStorageAvailable", this).call(this, e)
        }
      }, {
        key: "showInterstitial",
        value: function() {
    ...
    function oa() {
      return oa = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, r) {
        var o = function(e, t) {
    ...
    const ca = function(t) {
      ...
      function y() {
        ...
        for (var t = arguments.length, r = new Array(t), o = 0; o < t; o++) r[o] = arguments[o];
        return sa(ia(e = d.call.apply(d, [this].concat(r))), "_contextId", null), sa(ia(e), "_placementId", null), sa(ia(e), "_leaderboardId", null), sa(ia(e), "_isPlayerAuthorized", !0), sa(ia(e), "_supportedApis", []), e
      }
      return r = y, o = [{
        key: "platformId",
        get: function() {
        ...
        get: function() {
          switch (this._platformSdk && this._platformSdk.getPlatform()) {
            ...
            case "WEB":
              return c.DESKTOP;
            default:
              return oa(aa(y.prototype), "deviceType", this)
          }
        }
      }, {
        key: "isPlayerAuthorizationSupported",
        ...
        value: function(e) {
          ...
          }))) : oa(aa(y.prototype), "sendMessage", this).call(this, e)
        }
      }, {
        key: "authorizePlayer",
        value: function() {
        ...
        key: "isStorageSupported",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL ? this._supportedApis.includes("getDataAsync") : oa(aa(y.prototype), "isStorageSupported", this).call(this, e)
        }
      }, {
        key: "isStorageAvailable",
        value: function(e) {
          return e === u.PLATFORM_INTERNAL ? this._isPlayerAuthorized : oa(aa(y.prototype), "isStorageAvailable", this).call(this, e)
        }
      }, {
        key: "getDataFromStorage",
        value: function(e, t, r) {
          ...
          return t === u.PLATFORM_INTERNAL ? new Promise((function(t, n) {
            ...
            o._platformSdk.player.getDataAsync(i).then((function(e) {
              var o = i.map((function(t) {
                var o = e[t];
                return r || "object" !== ta(o) || null === o ? null != o ? o : null : JSON.stringify(o)
              }));
              t(o)
            })).catch(n)
          })) : oa(aa(y.prototype), "getDataFromStorage", this).call(this, e, t, r)
        }
      }, {
        key: "setDataToStorage",
        value: function(e, t, r) {
          ...
          })) : oa(aa(y.prototype), "setDataToStorage", this).call(this, e, t, r)
        }
      }, {
        key: "deleteDataFromStorage",
        value: function(e, t) {
          ...
          })) : oa(aa(y.prototype), "deleteDataFromStorage", this).call(this, e, t)
        }
      }, {
        key: "showBanner",
        value: function(e) {
      ...
      }], o && ra(r.prototype, o), Object.defineProperty(r, "prototype", {
        writable: !1
      }), y
    }(qt);
    ...
    function fa(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, pa(o.key), o)
      }
    }
    ...
    var da = function() {
      ...
      }], r && fa(t.prototype, r), Object.defineProperty(t, "prototype", {
        writable: !1
      }), e
    }();
    ...
    function ma(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, Ea(o.key), o)
      }
    }

    function va() {
      return va = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, r) {
        var o = function(e, t) {
    ...
    var Aa = "banner",
      wa = "get_data_from_storage",
      Oa = "get_server_time",
      ka = "clipboard_read",
      Da = "unlock_achievement",
      Ra = "get_achievements",
      Ta = "isStorageInternalSupported",
      Ia = "isStorageLocalSupported",
      La = new WeakMap;
    const ja = function(r) {
      ! function(e, t) {
        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
      ...
      function y() {
        ...
        for (var n = arguments.length, i = new Array(n), a = 0; a < n; a++) i[a] = arguments[a];
        return t = Sa(e = d.call.apply(d, [this].concat(i))), r = La, o = {
            writable: !0,
            value: new da
          },
          function(e, t) {
            if (t.has(e)) throw new TypeError("Cannot initialize the same private elements twice on an object")
          }(t, r), r.set(t, o), ba(Sa(e), "_supportedFeatures", []), e
      }
      return o = y, n = [{
        key: "platformId",
        get: function() {
        ...
        value: function() {
          ...
          return r || (r = this._createPromiseDecorator(f.INITIALIZE), this._defaultStorageType = u.PLATFORM_INTERNAL, Pa(this, La).addListener((function(r) {
            var o = r.data;
            (null == o ? void 0 : o.type) === t.PLATFORM && o.action === f.INITIALIZE && (e._supportedFeatures = o.supportedFeatures, e._isBannerSupported = e._supportedFeatures.includes("isBannerSupported"), e._isInitialized = !0, e._resolvePromiseDecorator(f.INITIALIZE), Pa(e, La).send({
              type: "liveness",
              action: "ping",
              options: {
                version: "1.19.0"
        ...
        value: function() {
          ...
          if (!r) {
            ...
            var o = Pa(this, La).generateMessageId();
            Pa(this, La).addListener((function r(n) {
              var i = n.data;
              if ((null == i ? void 0 : i.type) === t.PLAYER && i.action === f.AUTHORIZE_PLAYER && i.id === o) {
                var a = i.player;
                e._isPlayerAuthorized = !0, e._playerId = a.userId, e._playerName = a.name, a.profilePictureUrl && (e._playerPhotos = [a.profilePictureUrl]), e._resolvePromiseDecorator(f.AUTHORIZE_PLAYER), Pa(e, La).removeListener(r)
              }
            })), Pa(this, La).send({
              type: t.PLAYER,
        ...
        key: "sendMessage",
        value: function(e) {
          return [l.GAME_READY, l.IN_GAME_LOADING_STARTED, l.IN_GAME_LOADING_STOPPED, l.GAMEPLAY_STARTED, l.GAMEPLAY_STOPPED, l.PLAYER_GOT_ACHIEVEMENT, l.GAME_OVER].includes(e) ? (Pa(this, La).send({
            type: t.PLATFORM,
            action: e
          }), Promise.resolve()) : va(ga(y.prototype), "sendMessage", this).call(this, e)
        }
      }, {
        key: "getServerTime",
        value: function() {
          var e = this;
          return new Promise((function(r, o) {
            var n, i = Pa(e, La).generateMessageId(),
              a = function a(s) {
                var u = s.data;
                if ((null == u ? void 0 : u.type) === t.PLATFORM && u.action === Oa && u.id === i) {
                  if (!u.time) return void o(new Error("Invalid server time"));
                  clearTimeout(n), r(u.time), Pa(e, La).removeListener(a)
                }
              };
            Pa(e, La).addListener(a), Pa(e, La).send({
              type: t.PLATFORM,
              action: Oa,
              id: i
            }), n = setTimeout((function() {
              o(new Error("Server time request timeout")), Pa(e, La).removeListener(a)
            }), 5e3)
          }))
        }
      }, {
        key: "isStorageSupported",
        value: function(e) {
          return Pa(this, La).send({
            type: t.STORAGE,
            action: "is_storage_supported",
            options: {
              storageType: e
            }
          }), !(e !== u.PLATFORM_INTERNAL || !this._supportedFeatures.includes(Ta)) || !(e !== u.LOCAL_STORAGE || !this._supportedFeatures.includes(Ia))
        }
      }, {
        key: "isStorageAvailable",
        value: function(e) {
        ...
        value: function(e, r, o) {
          var n = this;
          if (r === u.PLATFORM_INTERNAL) {
            var i = Pa(this, La).generateMessageId();
            return new Promise((function(a) {
              Pa(n, La).addListener((function e(r) {
                var o = r.data;
                if ((null == o ? void 0 : o.type) === t.STORAGE && o.action === wa && o.id === i) {
                  var s = Object.values(o.storage);
                  a(s), Pa(n, La).removeListener(e)
                }
              })), Pa(n, La).send({
                type: t.STORAGE,
                action: wa,
          ...
          }), va(ga(y.prototype), "getDataFromStorage", this).call(this, e, r, o)
        }
      }, {
        key: "setDataToStorage",
        value: function(e, r, o) {
          ...
          }), o === u.PLATFORM_INTERNAL ? Promise.resolve() : va(ga(y.prototype), "setDataToStorage", this).call(this, e, r, o)
        }
      }, {
        key: "deleteDataFromStorage",
        value: function(e, r) {
          ...
          }), r === u.PLATFORM_INTERNAL ? Promise.resolve() : va(ga(y.prototype), "deleteDataFromStorage", this).call(this, e, r)
        }
      }, {
        key: "showInterstitial",
        value: function() {
          var e = this;
          Pa(this, La).addListener((function r(o) {
            var n = o.data;
            if ((null == n ? void 0 : n.type) === t.ADVERTISEMENT) switch (n.payload.status) {
              ...
              case "open":
                ...
                break;
              case "close":
                e._setInterstitialState(i.CLOSED), Pa(e, La).removeListener(r)
            }
          })), Pa(this, La).send({
          ...
          Pa(this, La).addListener((function r(o) {
            ...
            if ((null == n ? void 0 : n.type) === t.ADVERTISEMENT) switch (n.payload.status) {
              ...
              case "rewarded":
                ...
                break;
              case "close":
                e._setRewardedState(a.CLOSED), Pa(e, La).removeListener(r)
            }
          })), Pa(this, La).send({
            type: t.ADVERTISEMENT,
            action: "reward"
        ...
        key: "showBanner",
        value: function() {
          this._setBannerState(s.SHOWN), Pa(this, La).send({
            type: t.ADVERTISEMENT,
            action: s.SHOWN,
            options: {
              type: Aa
        ...
        key: "hideBanner",
        value: function() {
          this._setBannerState(s.HIDDEN), Pa(this, La).send({
            type: t.ADVERTISEMENT,
            action: s.HIDDEN,
            options: {
              type: Aa
        ...
        value: function() {
          ...
          }), va(ga(y.prototype), "checkAdBlock", this).call(this)
        }
      }, {
        key: "inviteFriends",
        value: function() {
          var e = this._getPromiseDecorator(f.INVITE_FRIENDS);
          return e || (e = this._createPromiseDecorator(f.INVITE_FRIENDS), this._resolvePromiseDecorator(f.INVITE_FRIENDS), Pa(this, La).send({
            type: t.SOCIAL,
        ...
        value: function() {
          ...
          return e || (e = this._createPromiseDecorator(f.JOIN_COMMUNITY), this._resolvePromiseDecorator(f.JOIN_COMMUNITY), Pa(this, La).send({
            type: t.SOCIAL,
        ...
        value: function() {
          ...
          return e || (e = this._createPromiseDecorator(f.SHARE), this._resolvePromiseDecorator(f.SHARE), Pa(this, La).send({
            type: t.SOCIAL,
            action: f.SHARE
          })), e.promise
        }
        ...
        value: function() {
          ...
          return e || (e = this._createPromiseDecorator(f.CREATE_POST), this._resolvePromiseDecorator(f.CREATE_POST), Pa(this, La).send({
            type: t.SOCIAL,
        ...
        value: function() {
          ...
          return e || (e = this._createPromiseDecorator(f.ADD_TO_HOME_SCREEN), this._resolvePromiseDecorator(f.ADD_TO_HOME_SCREEN), Pa(this, La).send({
            type: t.SOCIAL,
        ...
        value: function() {
          ...
          return e || (e = this._createPromiseDecorator(f.ADD_TO_FAVORITES), this._resolvePromiseDecorator(f.ADD_TO_FAVORITES), Pa(this, La).send({
            type: t.SOCIAL,
        ...
        value: function() {
          var e = this._getPromiseDecorator(f.RATE);
          return e || (e = this._createPromiseDecorator(f.RATE), this._resolvePromiseDecorator(f.RATE), Pa(this, La).send({
            type: t.SOCIAL,
            action: f.RATE
          })), e.promise
        }
          ...
          if (!r) {
            ...
            Pa(this, La).addListener((function r(n) {
              ...
              if ((null == i ? void 0 : i.type) === t.PAYMENTS && i.action === f.PURCHASE && i.id === o) {
                if (!i.purchase || "object" !== ha(i.purchase)) return void e._rejectPromiseDecorator(f.PURCHASE, new Error("Invalid purchase"));
                e._resolvePromiseDecorator(f.PURCHASE, i.purchase), Pa(e, La).removeListener(r)
              }
            })), Pa(this, La).send({
              type: t.PAYMENTS,
              action: f.PURCHASE,
        ...
        value: function() {
          ...
          if (!r) {
            ...
            Pa(this, La).addListener((function r(n) {
              var i = n.data;
              (null == i ? void 0 : i.type) === t.PAYMENTS && i.action === f.GET_PURCHASES && i.id === o && (e._resolvePromiseDecorator(f.GET_PURCHASES, i.purchases), Pa(e, La).removeListener(r))
            })), Pa(this, La).send({
              type: t.PAYMENTS,
        ...
        value: function() {
          ...
          if (!r) {
            ...
            Pa(this, La).addListener((function r(n) {
              var i = n.data;
              (null == i ? void 0 : i.type) === t.PAYMENTS && i.action === f.GET_CATALOG && i.id === o && (e._resolvePromiseDecorator(f.GET_CATALOG, i.catalog), Pa(e, La).removeListener(r))
            })), Pa(this, La).send({
              type: t.PAYMENTS,
        ...
        value: function() {
          ...
          if (!r) {
            ...
            Pa(this, La).addListener((function r(n) {
              var i = n.data;
              (null == i ? void 0 : i.type) === t.PAYMENTS && i.action === f.CONSUME_PURCHASE && i.id === o && (e._resolvePromiseDecorator(f.CONSUME_PURCHASE, i.result), Pa(e, La).removeListener(r))
            })), Pa(this, La).send({
              type: t.PAYMENTS,
        ...
        value: function() {
          ...
          if (!r) {
            ...
            Pa(this, La).addListener((function r(n) {
              var i = n.data;
              (null == i ? void 0 : i.type) === t.REMOTE_CONFIG && i.action === f.GET_REMOTE_CONFIG && i.id === o && (e._resolvePromiseDecorator(f.GET_REMOTE_CONFIG, i.result), Pa(e, La).removeListener(r))
            })), Pa(this, La).send({
        ...
        value: function(e) {
          ...
          if (!o) {
            ...
            var n = Pa(this, La).generateMessageId();
            Pa(this, La).addListener((function e(o) {
              var i = o.data;
              (null == i ? void 0 : i.type) === t.CLIPBOARD && i.action === f.CLIPBOARD_WRITE && i.id === n && (r._resolvePromiseDecorator(f.CLIPBOARD_WRITE, !0), Pa(r, La).removeListener(e))
            })), Pa(this, La).send({
              type: t.CLIPBOARD,
        ...
        value: function() {
          var e = this,
            r = this._getPromiseDecorator(ka);
          if (!r) {
            r = this._createPromiseDecorator(ka);
            var o = Pa(this, La).generateMessageId();
            Pa(this, La).addListener((function r(n) {
              var i = n.data;
              if ((null == i ? void 0 : i.type) === t.CLIPBOARD && i.action === ka && i.id === o) {
                var a = i.text;
                e._resolvePromiseDecorator(ka, a), Pa(e, La).removeListener(r)
              }
            })), Pa(this, La).send({
              type: t.CLIPBOARD,
              action: ka,
        ...
        value: function(e) {
          ...
          if (!r) {
            ...
            "string" == typeof o.score && (o.score = parseInt(o.score, 10)), Pa(this, La).send({
              type: t.LEADERBOARD,
        ...
        value: function(e) {
          ...
          if (!a) {
            ...
            var s = Pa(this, La).generateMessageId();
            Pa(this, La).addListener((function e(o) {
              var a = o.data;
              (null == a ? void 0 : a.type) === t.LEADERBOARD && a.action === f.GET_LEADERBOARD_SCORE && a.id === s && a.leaderboardName === n && (r._resolvePromiseDecorator(i, a.score), Pa(r, La).removeListener(e))
            })), Pa(this, La).send({
              type: t.LEADERBOARD,
        ...
        value: function(e) {
          ...
          if (!o) {
            ...
            Pa(this, La).addListener((function e(o) {
              var i;
              (null === (i = o.data) || void 0 === i ? void 0 : i.type) === t.LEADERBOARD && o.data.action === f.GET_LEADERBOARD_ENTRIES && o.data.id === n && (r._resolvePromiseDecorator(f.GET_LEADERBOARD_ENTRIES, o.data.entries), Pa(r, La).removeListener(e))
            })), Pa(this, La).send({
              type: t.LEADERBOARD,
        ...
        value: function(e) {
          ...
          return r || (r = this._createPromiseDecorator(f.SHOW_LEADERBOARD_NATIVE_POPUP), Pa(this, La).send({
            type: t.LEADERBOARD,
        ...
        value: function(e) {
          ...
          return new Promise((function(o) {
            var n = Pa(r, La).generateMessageId();
            Pa(r, La).addListener((function e(i) {
              var a = i.data;
              (null == a ? void 0 : a.type) === t.ACHIEVEMENTS && a.action === Da && a.id === n && (o(a.result), Pa(r, La).removeListener(e))
            })), Pa(r, La).send({
              type: t.ACHIEVEMENTS,
              action: Da,
              id: n,
        ...
        value: function(e) {
          ...
          return new Promise((function(o) {
            ...
            Pa(r, La).addListener((function e(i) {
              var a = i.data;
              (null == a ? void 0 : a.type) === t.ACHIEVEMENTS && a.action === Ra && a.id === n && (o(a.result), Pa(r, La).removeListener(e))
            })), Pa(r, La).send({
              type: t.ACHIEVEMENTS,
              action: Ra,
              id: n,
      ...
      }], n && ma(o.prototype, n), Object.defineProperty(o, "prototype", {
        writable: !1
      }), y
    }(qt);
    ...
    function Ba(e, t) {
      for (var r = 0; r < t.length; r++) {
        var o = t[r];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, Ma(o.key), o)
      }
    }
    ...
    function es(e) {
      return Wa(this, Va) || console.error(p), Wa(this, Ka)[e]
    }
    const ts = function() {
      function r() {
        ! function(e, t) {
          if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
        }(this, r), Fa(this, $a), Fa(this, qa), Fa(this, Ja), Ga(this, Va, {
          writable: !0,
          value: !1
        }), Ga(this, Ya, {
          writable: !0,
      ...
      return f = r, p = [{
        ...
        key: "platform",
        get: function() {
          return za(this, $a, es).call(this, t.PLATFORM)
        }
      }, {
        key: "player",
        get: function() {
          return za(this, $a, es).call(this, t.PLAYER)
        }
      }, {
        key: "game",
        get: function() {
          return za(this, $a, es).call(this, t.GAME)
        }
      }, {
        key: "storage",
        get: function() {
          return za(this, $a, es).call(this, t.STORAGE)
        }
      }, {
        key: "advertisement",
        get: function() {
          return za(this, $a, es).call(this, t.ADVERTISEMENT)
        }
      }, {
        key: "social",
        get: function() {
          return za(this, $a, es).call(this, t.SOCIAL)
        }
      }, {
        key: "device",
        get: function() {
          return za(this, $a, es).call(this, t.DEVICE)
        }
      }, {
        key: "leaderboard",
        get: function() {
          return za(this, $a, es).call(this, t.LEADERBOARD)
        }
      }, {
        key: "payments",
        get: function() {
          return za(this, $a, es).call(this, t.PAYMENTS)
        }
      }, {
        key: "achievements",
        get: function() {
          return za(this, $a, es).call(this, t.ACHIEVEMENTS)
        }
      }, {
        key: "remoteConfig",
        get: function() {
          return za(this, $a, es).call(this, t.REMOTE_CONFIG)
        }
      }, {
        key: "clipboard",
        get: function() {
          return za(this, $a, es).call(this, t.CLIPBOARD)
        }
      }, {
        key: "PLATFORM_ID",
        get: function() {
        ...
        value: function(e) {
          var r = this;
          return Wa(this, Va) ? Promise.resolve() : (Wa(this, Ya) || (Ua(this, Ya, new T), this._options = function(e) {
            for (var t = 1; t < arguments.length; t++) {
              var r = null != arguments[t] ? arguments[t] : {};
              t % 2 ? Ca(Object(r), !0).forEach((function(t) {
                var o, n, i;
                o = e, n = t, i = r[t], (n = Ma(n)) in o ? Object.defineProperty(o, n, {
                  value: i,
                  enumerable: !0,
                  configurable: !0,
                  writable: !0
            ...
            return e
          }({}, e), za(this, Ja, Xa).call(this), Wa(this, Za).initialize().then((function() {
            Wa(r, Ka)[t.PLATFORM] = new W(Wa(r, Za)), Wa(r, Ka)[t.PLAYER] = new J(Wa(r, Za)), Wa(r, Ka)[t.GAME] = new ne(Wa(r, Za)), Wa(r, Ka)[t.STORAGE] = new le(Wa(r, Za)), Wa(r, Ka)[t.ADVERTISEMENT] = new Qe(Wa(r, Za)), Wa(r, Ka)[t.SOCIAL] = new it(Wa(r, Za)), Wa(r, Ka)[t.DEVICE] = new ft(Wa(r, Za)), Wa(r, Ka)[t.LEADERBOARD] = new vt(Wa(r, Za)), Wa(r, Ka)[t.PAYMENTS] = new Pt(Wa(r, Za)), Wa(r, Ka)[t.REMOTE_CONFIG] = new Rt(Wa(r, Za)), Wa(r, Ka)[t.CLIPBOARD] = new Ct(Wa(r, Za)), Wa(r, Ka)[t.ACHIEVEMENTS] = new Ut(Wa(r, Za)), Ua(r, Va, !0), console.info("%c PlaygamaBridge v.".concat(r.version, " initialized. "), "background: #01A5DA; color: white"), Wa(r, Ya) && (Wa(r, Ya).resolve(), Ua(r, Ya, null))
          }))), Wa(this, Ya).promise)
        }
      }], p && Ba(f.prototype, p), Object.defineProperty(f, "prototype", {
        writable: !1
      }), r
    }();
    window.bridge = new ts, window.playgamaBridge = window.bridge
  })()
})();